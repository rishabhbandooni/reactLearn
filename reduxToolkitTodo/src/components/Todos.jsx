...
function Todos() {
  ...
  const { text, contentError, id } = state;

  const edit = () => {
    if (text === "") {
      // Fixed typo: changed 'content' to 'text'
  ...
  return (
    <>
      <div className="m-6 py-2 px-4 text-white bg-indigo-500 border-0 focus:outline-none hover:bg-indigo-600 rounded text-lg">
        Added Todos
      </div>
      {isEditing ? (
        <div className="form">
